...
export default function HeroUITest() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-8" dir="ltr">
      <h1 className="text-2xl font-bold">HeroUI Integration Test</h1>

      {/* Test 1: Basic components */}
      <div className="space-y-4">
        <h2 className="text-lg font-semibold">Basic Components</h2>
        <div className="flex gap-4 items-center flex-wrap">
          ...
          <Chip color="warning" variant="flat">Vacation</Chip>
        </div>
        <div className="max-w-sm">
          <Input label="Test Input" placeholder="Type something..." variant="bordered" />
        </div>
      </div>

      {/* Test 2: Table with custom cells (exact HeroUI example) */}
      <div className="space-y-4">
        <h2 className="text-lg font-semibold">Table with Custom Cells</h2>
