...
export function StudentDashboardView({
  ...
  return (
    <div className="space-y-5">
      {/* Row 1: ProfileCard | Stats+Attendance stacked | Agenda */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        {/* Center column: 2x2 stat cards + attendance below */}
        <div className="flex flex-col gap-3">
          {/* 2x2 compact stat cards */}
          <div className="grid grid-cols-2 gap-0.5">
            <GlassStatCard size="sm" value={dashboardData.totalWeeklyHours} label="שעות שבועיות" className="!h-[90px] !p-2.5" />
            <GlassStatCard size="sm" value={dashboardData.orchestraCount} label="תזמורות" className="!h-[90px] !p-2.5" />
            <GlassStatCard size="sm" value={dashboardData.theoryCount} label="שיעורי תאוריה" className="!h-[90px] !p-2.5" />
            <GlassStatCard
              size="sm"
