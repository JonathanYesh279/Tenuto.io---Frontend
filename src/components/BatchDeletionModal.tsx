...
import { CheckCircleIcon, CircleNotchIcon, ClockIcon, DatabaseIcon, ShieldIcon, TrashIcon, UsersIcon, WarningIcon, XCircleIcon, XIcon } from '@phosphor-icons/react'
          ...
          {step === 'progress' && (
            <div className="p-6">
              <div className="text-center">
                <div className="mb-4">
                  <CircleNotchIcon className="w-12 h-12 animate-spin text-red-600 mx-auto" />
                </div>
