...
- Remove from lucide import: `ArrowRight` (no longer needed — DetailPageHeader has its own breadcrumb nav with ChevronLeft)
...
4. Grep for `ArrowRight` in StudentDetailsPageSimple.tsx — should NOT appear in lucide import
