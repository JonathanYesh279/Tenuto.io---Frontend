...
must_haves:
  ...
  key_links:
    - from: "src/components/domain/DetailPageHeader.tsx"
      ...
      via: "import getAvatarColorClasses"
   ...
   <div className="bg-gradient-to-l from-primary to-accent rounded-xl p-6 text-white">
     <div className="flex items-center gap-4">
       <AvatarInitials
         ...
         fullName={fullName}
         size="xl"
         colorClassName="bg-white/20 text-white"
       />
...
<success_criteria>
- Teacher detail page header has warm gradient strip (from-primary to-accent), avatar initials with xl size and white overlay color, breadcrumb "מורים > שם", updatedAt beneath name, and role/instrument badges
